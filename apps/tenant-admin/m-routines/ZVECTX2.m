...
RUN ;
 ...
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE ROLE CUSTOM UPD")
 ...
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE USMG CHKAC")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE USER CLONE")
 ;
 ; Extension data RPCs (ZVEUEXT.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE UEXT SET")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE UEXT GET")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE UEXT GETALL")
 ;
 ; Mail group management RPCs (ZVEMGRP.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE MAILGRP MEMBERS")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE MAILGRP ADD")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE MAILGRP REMOVE")
 ;
 ; Clinic availability RPCs (ZVECLAVL.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE CLINIC AVAIL GET")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE CLINIC AVAIL SET")
 ;
 ; Device management RPCs (ZVEDEV.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE DEV CREATE")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE DEV TESTPRINT")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE DEV INFO")
 ;
 ; Data dictionary field labels (ZVEFLDS.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE DD FIELDS")
 ;
 ; HL7 status RPCs (ZVEHLFIL.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE HL7 FILER STATUS")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE HL7 LINK STATUS")
 ;
 ; Health summary RPCs (ZVEHSCOMP.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE HS COMPONENTS")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE HS COMP ADD")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE HS COMP REMOVE")
 ;
 ; TaskMan status RPCs (ZVETMCTL.m)
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE TASKMAN STATUS")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE TASKMAN DETAIL")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE TASKMAN TASKS")
 D ADDRPC^ZVECTXR(ADMCTX,"ZVE TASKMAN START")
 ;
