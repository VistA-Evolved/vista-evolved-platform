      ...
      <div className="flex h-[calc(100vh-40px)]">
        <div className={`p-6 overflow-auto ${display ? 'w-full xl:w-[55%]' : 'w-full'}`}>
          <div className="max-w-[1400px]">
            ...
            {loading ? <TableSkeleton rows={10} cols={5} /> : groups.length === 0 ? (
              <div className="py-12 text-center border border-[#E2E4E8] rounded-lg bg-white">
                <p className="text-sm text-gray-500 mb-4">No mail groups found.</p>
                <button
                  type="button"
                  onClick={() => { setShowCreateModal(true); setCreateError(null); setCreateForm({ name: '', description: '' }); }}
