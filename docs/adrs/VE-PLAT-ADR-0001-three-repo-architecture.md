...
- **vista-evolved-platform** - Control plane, tenant-admin operational shell, contracts (OpenAPI, AsyncAPI, schemas), config (ports, modules, tenants), domain, UI design system. No VistA runtime or distro build.
