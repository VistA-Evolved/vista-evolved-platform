...
Enterprise-namespaced ADRs for VistA Evolved Platform.

ADR IDs use the format `VE-PLAT-ADR-NNNN`. See [Decision Index](../reference/decision-index.yaml) for the full cross-repo registry.
