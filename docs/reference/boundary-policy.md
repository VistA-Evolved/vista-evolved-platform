...
- **Bounded contexts** are reflected in directory layout and CODEOWNERS: `apps/control-plane/`, `apps/control-plane-api/`, `apps/tenant-admin/`, `apps/admin-console/` (placeholder), `packages/contracts/`, `packages/config/`, `packages/domain/`, `packages/ui/`.
