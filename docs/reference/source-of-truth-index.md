...
| Control-panel design contract and static-review prototype batch 1 | `docs/explanation/control-panel-design-contract-and-static-review-prototype-batch-1.md` | **Partially superseded.** Design contract: layout regions, reject/ready checklists for 8 surfaces. Layout and review criteria remain valid; page specs and action semantics moved to v2 docs. |
